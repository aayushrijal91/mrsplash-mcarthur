        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="fs-20 lh-1_65 py-4 text-light-grey"><?= $section_1['description'] ?></div>
                ...
                <div class="col-xl-11">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="fs-20 lh-1_65 py-4"><?= $section_2['description'] ?></div>
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-5">
                    ...
                    <div class="fs-20 lh-1_65 py-4 text-light-grey"><?= $section_3['description'] ?></div>
                    <a href="<?= $section_3['button']['url'] ?>" class="btn rounded-pill btn-primary-light d-inline-flex text-white fs-18 fw-700 px-4 px-xl-5"><?= $section_3['button']['title'] ?></a>
                </div>
                <div class="col-lg-6">
